...
public class MappingStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new tadp.examples.MappingRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.examples.tadp/Mapping")) {
		EPackage.Registry.INSTANCE.put("http://www.examples.tadp/Mapping", tadp.examples.mapping.MappingPackage.eINSTANCE);
	}
